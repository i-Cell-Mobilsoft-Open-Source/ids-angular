...
import { ActivatedRoute, Router, RouterOutlet, RouterLinkWithHref, RouterLinkActive, RouterModule, NavigationEnd } from '@angular/router';
  ...
  public ngOnInit(): void {
    ...
    slug$
      ...
      .subscribe((component) => {
        ...
        const child = this._route.firstChild?.snapshot.url[0]?.path ?? 'demo';
        this.selectedSection = child;
      });
  }
