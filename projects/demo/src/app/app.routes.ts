...
function buildComponentRoute(slug: string, translationKey: string, demoService: Provider | EnvironmentProviders): Route {
    ...
    children: [
      {
        ...
        children: [
          ...
          buildComponentRoute('accordion', 'COMPONENTS.ACCORDION', AccordionDemoService),
          buildComponentRoute('autocomplete', 'COMPONENTS.AUTOCOMPLETE', AutocompleteDemoService),
          buildComponentRoute('avatar', 'COMPONENTS.AVATAR', AvatarDemoService),
          buildComponentRoute('badge', 'COMPONENTS.BADGE', BadgeDemoService),
          buildComponentRoute('breadcrumb', 'COMPONENTS.BREADCRUMB', BreadcrumbDemoService),
          buildComponentRoute('button', 'COMPONENTS.BUTTON', ButtonDemoService),
          buildComponentRoute('card', 'COMPONENTS.CARD', CardDemoService),
          buildComponentRoute('checkbox', 'COMPONENTS.CHECKBOX', CheckboxDemoService),
          buildComponentRoute('checkbox-group', 'COMPONENTS.CHECKBOX_GROUP', CheckboxGroupDemoService),
          buildComponentRoute('chip', 'COMPONENTS.CHIP', ChipDemoService),
          buildComponentRoute('date-picker', 'COMPONENTS.DATE_PICKER', DatepickerDemoService),
          buildComponentRoute('dialog', 'COMPONENTS.DIALOG', DialogDemoService),
          ...
          buildComponentRoute('message', 'COMPONENTS.MESSAGE', MessageDemoService),
          buildComponentRoute('notification', 'COMPONENTS.NOTIFICATION', NotificationDemoService),
          buildComponentRoute('option', 'COMPONENTS.OPTION', OptionDemoService),
          buildComponentRoute('overlay-panel', 'COMPONENTS.OVERLAY_PANEL', OverlayPanelDemoService),
          buildComponentRoute('paginator', 'COMPONENTS.PAGINATOR', PaginatorDemoService),
          buildComponentRoute('radio', 'COMPONENTS.RADIO', RadioDemoService),
          buildComponentRoute('scrollbar', 'COMPONENTS.SCROLLBAR', ScrollbarDemoService),
          buildComponentRoute('segmented-control', 'COMPONENTS.SEGMENTED_CONTROL', SegmentedControlDemoService),
          buildComponentRoute('segmented-control-toggle', 'COMPONENTS.SEGMENTED_CONTROL_TOGGLE', SegmentedControlToggleDemoService),
          buildComponentRoute('select', 'COMPONENTS.SELECT', SelectDemoService),
          buildComponentRoute('side-nav', 'COMPONENTS.SIDE_NAV', SideNavDemoService),
          buildComponentRoute('side-sheet', 'COMPONENTS.SIDE_SHEET', SideSheetDemoService),
          buildComponentRoute('snackbar', 'COMPONENTS.SNACKBAR', SnackbarDemoService),
          buildComponentRoute('spinner', 'COMPONENTS.SPINNER', SpinnerDemoService),
          buildComponentRoute('switch', 'COMPONENTS.SWITCH', SwitchDemoService),
          buildComponentRoute('tab', 'COMPONENTS.TAB', TabDemoService),
          buildComponentRoute('table', 'COMPONENTS.TABLE', TableDemoService),
          buildComponentRoute('tag', 'COMPONENTS.TAG', TagDemoService),
          buildComponentRoute('tooltip', 'COMPONENTS.TOOLTIP', TooltipDemoService),
        ],
      },
      {
        path: 'home',
