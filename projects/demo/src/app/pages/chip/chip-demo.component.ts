...
import { IdsChipComponent } from '@i-cell/widgets/chip';
import { ChipAppearance, ChipAppearanceType, SizeType, SurfaceVariant, SurfaceVariantType } from '@i-cell/widgets/core';
